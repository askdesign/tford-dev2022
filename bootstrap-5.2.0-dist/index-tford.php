...
<html lang="en">
  ...
  <body>
            ...
            <ul class="navbar-nav breadcrumb">
              ...
              <li class="breadcrumb-item">
               ...
               <li class="breadcrumb-item dropdown">
                <a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">Project Profiles</a>
    ...
    <footer class="site-footer bg-dark">
        <p>
          © 2024 T Ford Company, Inc. 978 352 5606 124 Tenney Street, Georgetown, MA 01833 
        </p>
